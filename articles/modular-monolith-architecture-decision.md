...
技術アドバイザーとして入っていただいている川島さん（[@kawasima](https://x.com/kawasima?s=21&t=jY7YjkqSwZLALKt4_CPg4w)）との継続的な対話の中で、この課題に対する捉え方が大きく変わっていきました。
...
[^7]: PIVOTは「日本をPIVOTする」をミッションに掲げるビジネス映像メディアで、映像コンテンツを日々配信しています。公式サイト: https://pivotmedia.co.jp/
...
既存のシステムは、PIVOTではビジネス映像メディアとして[^7]、**コンテンツを一方向に届ける体験**を前提としていました。ユーザーは基本的に「**閲覧する側**」として完結しており、双方向のやり取りはほとんど想定されていない世界でした。

一方で、コメント機能は**ユーザー参加型**であり、投稿・表示・通知・モデレーションなど、既存機能とは明らかに異なる関心やルールを持つ世界です。**全く違うBounded Context**というべきものでした。
