...
2024年3月、Devinの発表が大きな話題となり、AI開発ツールへの注目が一気に高まりました。それ以前からGitHub Copilot Chat（2023年12月一般提供開始）などは存在していましたが、Devinをきっかけに開発支援AIツールが次々と登場しました。

2024年後半にはCursor（8月に大型資金調達、11月に大規模アップデート）、Windsurf（11月15日リリース）、Clineなど、エディタ統合型のAI開発ツールが相次いで登場。そして2025年に入ると、Anthropic公式のClaude Code（2月発表）やGitHubのCodex CLIなど、さらに多様なツールが出てきました。

私たちのチームでは、**他社も多分に漏れず**、こうした新しいツールが出てくるたびに**チームとして積極的に試す文化**を作ってきました。個人で興味がある人が率先して情報を拾い、「これは良さそう」というものはチームでも柔軟に試せるようにする。そういった形で継続的に検討してきました。
