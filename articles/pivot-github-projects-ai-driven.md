...
2024年3月、Devinが話題になったのを皮切りに、さまざまなAI開発ツールが次々と登場しました。Copilot Chatから始まり、その後Clineが出て、そして2024年後半にはClaude CodeやCodex CLIといったツールが登場しました。

私たちのチームでは、こうした新しいツールが出てくるたびに、**チームとして積極的に試す文化**を作ってきました。個人で興味がある人が率先して情報を拾い、「これは良さそう」というものはチームでも柔軟に試せるようにする。そういった形で継続的に検討してきました。
