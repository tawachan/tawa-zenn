...
AIの進化により、私たちの開発プロセスは根本から変わりつつあります。プロジェクトの進め方そのものを見直すような大きな変化も必要で、実際PIVOTでもスクラムからカンバンへの移行を行いました。その経緯は以前の記事「[スクラムからカンバンへの移行——ソフトウェアエンジニアがマネージャーになる時代に](https://zenn.dev/pivotmedia/articles/engineer-as-manager-scrum-to-kanban)」で詳しく書いています。
